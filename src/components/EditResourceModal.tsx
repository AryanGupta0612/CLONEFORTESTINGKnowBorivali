...
function EditResourceModal({ resource, onClose, onSuccess }: EditResourceModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await submitResourceEdit(resource.id, editData);

      if (result.success) {
        onSuccess();
      } else {
        setErrors({ submit: 'Failed to submit edit. Please try again.' });
      }
