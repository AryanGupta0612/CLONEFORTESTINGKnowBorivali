        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              placeholder="e.g., Shree Sai Hospital"
            />
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              placeholder="e.g., IC Colony, Borivali West, Mumbai - 400103"
            />
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., +91 22 2898 5678"
            />
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              placeholder="Provide a detailed description of the resource and what services it offers..."
            />
